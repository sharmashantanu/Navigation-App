...
public class MainDepartments extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.main_departments, menu);
        return true;
    }
    ...
    private void Menu(int id){
        ...
        switch(id){
            case R.id.nav_computer :
                ...
                break;
            //case R.id.nav_electrical :
              //  fragment = new electrical();
               // break;
