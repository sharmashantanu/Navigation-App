...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> cadapter = ArrayAdapter.createFromResource(this,R.array.input_name_teachers, android.R.layout.simple_spinner_item);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        // signed in user can be handled in the listener.
                            ...
                            Coordinate co=new Coordinate(username_id,"23.767679","78.987878","false");
                         //   Log.d("hello",co.getLatitude()+co.getLongitude()+co.getName());
                            String ee=co.getLatitude();
                            HashMap<String,Coordinate> users = new HashMap<>();
                            users.put(email_id,new Coordinate(username_id,"23.767679","78.987878","false"));
                            mReference.child(encoded(email)).setValue(co);
                            //mReference.updateChildren(users);

                            computer c=new computer();
                            c.setemail(encoded(email));
